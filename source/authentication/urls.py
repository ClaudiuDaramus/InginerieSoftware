...
urlpatterns = [
    re_path('api-token-auth/', views.obtain_auth_token, name='auth'),
    re_path('register/', UserRegisterView.as_view(), name='register'),
    re_path('dummy/', dummyView, name='dummy'),
    re_path('login/', UserLoginView.as_view(), name='login'),
    re_path('create/profile/', createNewProfile, name='create-profile'),
    path('get/profiles/<slug:name>', getProfiles, name='get-profile'),
    path('get/profiles/', getProfiles, name='get-profiles'),
    re_path('update/profile/', updateProfile, name='update-profile'),
    re_path('delete/profile/', deleteProfile, name='delete-profile'),
    re_path('get/fakes/', getFakeList, name='get-fake-persons'),
    re_path('location/', getUserLocation, name='get-location'),
]
